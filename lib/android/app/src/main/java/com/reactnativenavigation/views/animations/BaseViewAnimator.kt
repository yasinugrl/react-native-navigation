...
open class BaseViewAnimator<T : View>(
    ...
    fun getPushAnimation(animation: ViewAnimationOptions, visible: BoolProp, additionalDy: Float = 0f): Animator? {
    ...
    fun getPopAnimation(animation: ViewAnimationOptions, visible: BoolProp, additionalDy: Float = 0f): Animator? {
        if (isOrWillBeVisible && visible.isFalse) {
            showAnimator.cancel()
            hideAnimator = animation.exit.getAnimation(view, defaultAnimatorCreator.getHideAnimator(view, hideDirection, additionalDy))
            return hideAnimator
    ...
    fun getSetStackRootAnimation(animation: ViewAnimationOptions, visible: BoolProp, additionalDy: Float = 0f): Animator? {
        if (isOrWillBeVisible && visible.isFalse) {
            showAnimator.cancel()
            hideAnimator = animation.exit.getAnimation(view, defaultAnimatorCreator.getHideAnimator(view, hideDirection, additionalDy))
            return hideAnimator
