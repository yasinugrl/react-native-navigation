...
public class NavigationModule extends NavigationModuleSpec {
    public static final String NAME = "RNNTurboModule";
    public static final String CLASS_NAME = "NavigationModule";
    ...
    public WritableMap getLaunchArgs(String commandId) {
        return LaunchArgsParser.parse(activity());
    }
