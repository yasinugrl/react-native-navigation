...
public class BottomTabsAnimator {
    ...
    public void hide(AnimationsOptions animationsOptions) {
        if (animationsOptions.pop.bottomTabs.exit.hasValue()) {
            AnimatorSet set = animationsOptions.pop.bottomTabs.exit.getAnimation(bottomTabs);
    ...
    public void show(AnimationsOptions animationsOptions) {
        if (animationsOptions.push.bottomTabs.enter.hasValue()) {
            AnimatorSet set = animationsOptions.push.bottomTabs.enter.getAnimation(bottomTabs);
            set.addListener(new AnimatorListenerAdapter() {
                @Override
                public void onAnimationEnd(Animator animation) {
