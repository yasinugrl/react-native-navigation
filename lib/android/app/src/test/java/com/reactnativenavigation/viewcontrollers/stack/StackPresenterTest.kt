...
class StackPresenterTest : BaseTest() {
    ...
    fun mergeTopBarOptions() {
        ...
        title.text = TextProp("abc")
        title.color = Colour(0)
        title.fontSize = Fraction(1.0)
        title.font = FontOptions()
        title.font.fontStyle = TextProp("bold")
        options.topBar.title = title
        val subtitleOptions = SubtitleOptions()
        subtitleOptions.text = TextProp("Sub")
        subtitleOptions.color = Colour(1)
        subtitleOptions.font.fontStyle = TextProp("bold")
        subtitleOptions.fontSize = Fraction(1.0)
        options.topBar.subtitle = subtitleOptions
        options.topBar.background.color = Colour(0)
        options.topBar.testId = TextProp("test123")
        options.topBar.animate = BoolProp(false)
        options.topBar.visible = BoolProp(false)
        options.topBar.drawBehind = BoolProp(false)
        options.topBar.hideOnScroll = BoolProp(false)
        options.topBar.validate()
        uut.mergeChildOptions(options, EMPTY_OPTIONS, parent, child)
        assertTopBarOptions(options, 1)
        options.topBar.drawBehind = BoolProp(true)
        uut.mergeChildOptions(options, EMPTY_OPTIONS, parent, child)
    }
    ...
    fun mergeOptions_defaultOptionsAreNotApplied() {
        ...
        val toMerge = Options()
        toMerge.topBar.title.text = TextProp("someText")
    ...
    fun mergeOptions_resolvedTitleFontOptionsAreApplied() {
        ...
        childOptions.topBar.title.font.fontFamily = TextProp(SOME_FONT_FAMILY)
        ...
        uut.defaultOptions = defaultOptions
        val toMerge = Options()
        toMerge.topBar.title.text = TextProp("New Title")
        uut.mergeOptions(toMerge, parent, child)
    ...
    fun mergeOptions_resolvedSubtitleFontOptionsAreApplied() {
        val childOptions = Options()
        childOptions.topBar.subtitle.font.fontFamily = TextProp(SOME_FONT_FAMILY)
        child.mergeOptions(childOptions)
        val parentOptions = Options()
        ...
        uut.defaultOptions = defaultOptions
        val toMerge = Options()
        toMerge.topBar.subtitle.text = TextProp("New Title")
        uut.mergeOptions(toMerge, parent, child)
    ...
    fun mergeChildOptions_resolvedTitleFontOptionsAreApplied() {
        ...
        resolvedOptions.topBar.title.font.fontFamily = TextProp(SOME_FONT_FAMILY)
    ...
    fun mergeChildOptions_resolvedSubtitleFontOptionsAreApplied() {
        ...
        uut.defaultOptions = defaultOptions
        val resolvedOptions = Options()
        resolvedOptions.topBar.subtitle.font.fontFamily = TextProp(SOME_FONT_FAMILY)
    ...
    fun mergeChildOptions_defaultOptionsAreNotApplied() {
        ...
        uut.defaultOptions = defaultOptions
        val childOptions = Options()
        childOptions.topBar.title.text = TextProp("someText")
    ...
    fun applyTopBarOptions_setTitleComponent() {
        ...
        applyComponent.topBar.title.component.name = TextProp("Component1")
        applyComponent.topBar.title.component.componentId = TextProp("Component1id")
    ...
    fun mergeTopBarOptions_settingTitleDestroysComponent() {
        ...
        titleOptions.topBar.title.text = TextProp("Some title")
    ...
    fun mergeTopTabsOptions() {
        ...
        options.topTabs.fontSize = IntProp(1)
        options.topTabs.visible = BoolProp(true)
        uut.mergeChildOptions(options, EMPTY_OPTIONS, parent, child)
    ...
    fun applyInitialChildLayoutOptions() {
        val options = Options()
        options.topBar.visible = BoolProp(false)
        options.topBar.animate = BoolProp(true)
    ...
    fun applyTopBarOptions_backgroundComponentIsCreatedOnceIfNameAndIdAreEqual() {
        val o = Options()
        o.topBar.background.component.name = TextProp("comp")
        o.topBar.background.component.componentId = TextProp("compId")
    ...
    fun applyTopInsets_topBarIsDrawnUnderStatusBarIfDrawBehindIsTrue() {
        val options = Options()
        options.statusBar.drawBehind = BoolProp(true)
    ...
    fun applyTopInsets_topBarIsDrawnUnderStatusBarIfStatusBarIsHidden() {
        val options = Options()
        options.statusBar.visible = BoolProp(false)
    ...
    fun applyChildOptions_shouldChangeTopMargin() {
        val options = Options()
        (topBar.layoutParams as ViewGroup.MarginLayoutParams).topMargin = 20
        options.topBar.topMargin = IntProp(10)
        uut.applyChildOptions(options, parent, child)
    ...
    private fun component(alignment: Alignment): ComponentOptions {
        ...
        component.name = TextProp("myComp")
        component.alignment = alignment
        component.componentId = TextProp("compId")
        return component
    }
