...
export class ComponentEventsObserver {
  ...
  public registerOnceForAllComponentEvents() {
    ...
    this.nativeEventsReceiver.experimental_registerComponentWillAppearListener(
      this.notifyComponentWillAppear
    );
  ...
  notifyComponentWillAppear(event: ComponentWillAppearEvent) {
    ...
    this.triggerOnAllListenersByComponentId(event, 'experimental_componentWillAppear');
  }
