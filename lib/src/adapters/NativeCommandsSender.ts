import NativeTurboModule, { ModuleSpec } from '../turboModule';
import { Platform, NativeModules } from 'react-native';

export class NativeCommandsSender {
  private readonly nativeCommandsModule: ModuleSpec;
  constructor() {
    if (Platform.OS === 'android') this.nativeCommandsModule = NativeTurboModule;
    else this.nativeCommandsModule = NativeModules.RNNBridgeModule;
  }
